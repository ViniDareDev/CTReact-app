...
import { DollarSign, Users, Clock, UserPlus, ChevronDown, ChevronUp } from "lucide-react";
...
const allTimeSlots = ["06:00", "07:00", "08:00", "09:00", "10:00", "11:00", "16:00", "17:00", "18:00", "19:00", "20:00"];
...
const AdminDashboard = () => {
  ...
  // Fetch teachers
  useEffect(() => {
    supabase.from("teachers").select("*").then(({ data }) => setTeachers(data || []));
  }, []);
  ...
  const handleCadastro = async (e: React.FormEvent) => {
    ...
    setModalidade(""); setTipoPlano(""); setFrequencia("");
  };
      ...
      <div className="animate-fade-in space-y-5">
        ...
        <div>
          <button
            ...
            className="flex w-full items-center justify-between glass-card p-4"
          >
          ...
          {showCadastro && (
            <form onSubmit={handleCadastro} className="glass-card mt-2 p-4 space-y-3 animate-fade-in">
              ...
              <div className="space-y-2">
                ...
                <RadioGroup value={modalidade} onValueChange={(v) => { setModalidade(v as Modalidade); setTipoPlano(""); setFrequencia(""); }} className="grid grid-cols-2 gap-2">
              ...
              {modalidade && availableTiposPlano.length > 0 && (
                <div className="space-y-2 animate-fade-in">
                  ...
                  <RadioGroup value={tipoPlano} onValueChange={(v) => { setTipoPlano(v as TipoPlano); setFrequencia(""); }} className="flex gap-2">
