          ...
          <div className="space-y-3 animate-fade-in">
            <div className="glass-card p-4 space-y-3">
              ...
              <div>
                ...
                <Input type="date" value={editBirthDate} onChange={(e) => setEditBirthDate(e.target.value)} className="border-border/50 bg-secondary/50 text-foreground focus:border-primary mt-1" />
              </div>
              <div>
